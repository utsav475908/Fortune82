...
@objc public protocol CardCollectionViewDataSource:class {
...
public class CardView: UIView {
    ...
    fileprivate func setUp() {
        ...
        let bottom = NSLayoutConstraint.init(item: collectionView, attribute: .bottom, relatedBy: .equal, toItem: collectionView.superview!, attribute: .bottom, multiplier: 1.0, constant: -150.0)
